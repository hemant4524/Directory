...
public class LockScreenActivity extends PinActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(LockScreenActivity.this, CustomPinActivity.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.button_not_locked:
                Intent intent2 = new Intent(LockScreenActivity.this, HomeActivity.class);
